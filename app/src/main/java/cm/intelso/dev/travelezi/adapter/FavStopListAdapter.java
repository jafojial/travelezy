...
public class FavStopListAdapter extends RecyclerView.Adapter<FavStopListAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bind(final StopItem stopItem, final FavStopListAdapter.OnItemClickListener listener) {
    ...
    // Constructor
    public FavStopListAdapter(Context aContext, ArrayList<StopItem> listStop, OnItemClickListener listener){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View contactView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_fav_stop_item_layout, parent, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull FavStopListAdapter.ViewHolder holder, int position) {
